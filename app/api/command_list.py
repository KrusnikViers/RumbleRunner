...
class CallbackId(IntEnum):
    ...
    TS_MATCHMAKING_MENU = 140
    TS_CHOOSE_TEAM_SETUP = 141
    TS_CHOOSE_WINNER_TEAM = 142
    TS_CUSTOM_TEAM_SETUP_MENU = 143
    TS_CUSTOM_TEAM_SETUP_CHOOSE_PLAYER = 144
    TS_CUSTOM_TEAM_SETUP_CONFIRM = 145
